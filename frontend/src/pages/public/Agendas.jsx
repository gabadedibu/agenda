...
export default function Agendas() {
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <section className="bg-slate-950 text-white px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-300 mt-3 max-w-2xl">
            Browse approved departmental agendas, public updates, and supporting
            documents.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-8">
        <form
          ...
          className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-3"
        >
          ...
          <button className="bg-slate-950 text-white px-6 py-3 rounded-xl font-semibold">
            Search
          </button>
        </form>
        ...
        {loading ? (
          ...
          <div className="mt-8 bg-white border border-slate-200 rounded-2xl p-10 text-center">
            <p className="text-slate-600 font-semibold">No approved agenda found.</p>
          </div>
        ) : (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
            {agendas.map((agenda) => (
              ...
              >
                ...
                <h2 className="font-bold text-lg text-slate-900 mt-4 line-clamp-2">
                  {agenda.title}
                </h2>
